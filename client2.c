...
int main(int argc, char *argv[])
{
	...
	//list function
        ...
        {
            retrieve(sockfd);}
        else if (i == 4){store(sockfd); }
    }*/
    int flagMessageNotSent = 0;
    while (flagMessageNotSent == 0){
	printf("You send a message");
	flagMessageNotSent = sendMsg("trash send online");
    }
...
//sends message
int sendMsg(char *msg){
	printf("started to send message.  not implemented yet");
	return -1;
}
